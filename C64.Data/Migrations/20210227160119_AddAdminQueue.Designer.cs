...
namespace C64.Data.Migrations
{
    ...
    [Migration("20210227160119_AddAdminQueue")]
    partial class AddAdminQueue
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("C64.Data.Entities.AdminQueue", b =>
                {
                    b.Property<int>("AdminQueueId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<int>("AdminQueueRequestType")
                        .HasColumnType("int");

                    b.Property<int>("AdminQueueStatus")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("ShowProcessorComment")
                        .HasColumnType("tinyint(1)");

                    b.HasKey("AdminQueueId");

                    b.HasIndex("CreatorUserId");

                    b.HasIndex("ProcessorUserId");

                    b.ToTable("adminqueues");
                });
            ...
            modelBuilder.Entity("C64.Data.Entities.AdminQueue", b =>
                {
                    b.HasOne("C64.Data.Entities.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("C64.Data.Entities.User", "ProcessorUser")
                        .WithMany()
                        .HasForeignKey("ProcessorUserId");

                    b.Navigation("CreatorUser");

                    b.Navigation("ProcessorUser");
                });
