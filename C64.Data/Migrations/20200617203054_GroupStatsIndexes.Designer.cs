...
namespace C64.Data.Migrations
{
    ...
    [Migration("20200617203054_GroupStatsIndexes")]
    partial class GroupStatsIndexes
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("C64.Data.Entities.GroupStat", b =>
                {
                    b.Property<int>("GroupStatId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("NumberOfReleases");

                    b.HasIndex("Views");

                    b.ToTable("GroupStats");
                });
            ...
            modelBuilder.Entity("C64.Data.Entities.ProductionStat", b =>
                {
                    b.Property<int>("ProductionStatId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("ProductionStatId");

                    b.HasIndex("ProductionId")
                        .IsUnique();

                    b.ToTable("ProductionStats");
                });
            ...
            modelBuilder.Entity("C64.Data.Entities.HiddenPart", b =>
                {
                    ...
                    b.HasOne("C64.Data.Entities.User", "SubmittedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("C64.Data.Entities.ProductionStat", b =>
                {
                    b.HasOne("C64.Data.Entities.Production", "Production")
                        .WithOne("ProductionStat")
                        .HasForeignKey("C64.Data.Entities.ProductionStat", "ProductionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
